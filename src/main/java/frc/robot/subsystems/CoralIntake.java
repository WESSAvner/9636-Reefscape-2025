...
public class CoralIntake extends SubsystemBase {
  ...
  private SparkMax coralIntakeMotor = new SparkMax(7, MotorType.kBrushless);
  private ProfiledPIDController pid = new ProfiledPIDController(0.00001, 0,0, new Constraints(0.1, 1));

  private AbsoluteEncoder absEncoder = coralIntakeMotor.getAbsoluteEncoder();
  ...
  public CoralIntake() {
    ...
    pid = new ProfiledPIDController(0.001, 0,0, new Constraints(0.5, 2));
